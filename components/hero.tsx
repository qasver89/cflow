...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-40 pb-24 md:pt-48 md:pb-32">
      <div className="absolute inset-0 -z-10 bg-gradient-to-b from-evergreen/5 via-transparent to-transparent" />
      ...
      <div className="container grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <span className="eyebrow">Coffee, Tea, Desserts &amp; More</span>
          ...
          <p className="mt-6 text-lg text-espresso/70 max-w-md leading-relaxed">
            Every order is made fresh when you order it — coffee pulled to
            order. Quick
            doesn&apos;t have to mean careless.
          </p>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -inset-8 rounded-3xl bg-evergreen/5 blur-2xl" />
